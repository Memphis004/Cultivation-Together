...
อัปเดตล่าสุด: 2026-09-20 (Clue System v2 (f): drag-drop workspace + 2-row library
...
PlayMode tests ผ่านครบ 11/11 A–K (rerun 2026-09-20 + เทส F assert ✏️ v4: label k ↔ tooltip k) —
ดู [[clue-system-v2-presentation]])
...
- [[clue-system-v2-presentation]] — Clue System v2 (f) (2026-09-16): Drag-drop workspace +
  ...
  + PlayMode tests A–K 11/11 PASS (TestEvidence/clue-system-v2-f — rerun 2026-09-20,
  เทส F assert ✏️ v4: ป้าย node k ↔ tooltip k ↔ witness Σ×N)
...
- [[deduction]] — ระบบ Social Deduction (clues, accusation, win/lose) — มีส่วน
  "AI Deduction Workflow" แนะนำลำดับการใช้ MCP tools (observe → collect → review →
  pin/unpin ของ player+AI ผ่าน get_pinned_clues/set_pinned_clue → reason → accuse)
  + สถานะอัปเดตแล้วตาม Clue System v2 (2026-09-15)
