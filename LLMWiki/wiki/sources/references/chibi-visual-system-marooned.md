...
> 📌 **External reference** — คัดลอกจากโปรเจกต์ Marooned (`marooned-wiki/wiki/sources/architecture/chibi-visual-system.md`, คนละ repo) — pattern reference เท่านั้น (IChibiVisual, event-driven, Spine 4.3 lessons) ไม่ใช่ source ของเกมนี้ ห้ามอ้างเป็นข้อกำหนดของเกมนี้
