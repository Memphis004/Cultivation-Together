...
- **Production activation (S4, 2026-09-25):** ☑ `visual_overrides verify` production-wiring pass=41 fail=0 — d000/d002 ใช้ rig ตัวเองผ่าน Q5 override, d003 ใช้ interim shared rig `1113103_1`, override อยู่นอก SpineBudget + visual spot-check บนฉากจริงผ่าน (รายละเอียด: [[concepts/disciple-visual-system]] §11 + [[decisions/visual-overrides-straight-alpha]])
